...
@injectable()
export abstract class AbstractWebsocketAdapter<K extends NAbstractWebsocketAdapter.WebsocketKind>
  implements IAbstractWebsocketAdapter
{
  ...
  protected abstract _instance: NAbstractWebsocketAdapter.Instance<K> | undefined;
