...
export class MongodbProvider implements IMongodbProvider {
  ...
  public async findById<TRawDocType, ResultDoc = Mongoose.THydratedDocumentType<TRawDocType>>(
    model: string,
    id: string,
  ...
  public async findOne<TRawDocType, ResultDoc = Mongoose.THydratedDocumentType<TRawDocType>>(
    model: string,
    filter?: Mongoose.FilterQuery<TRawDocType>,
  ...
  public async updateOne<TRawDocType, ResultDoc = Mongoose.THydratedDocumentType<TRawDocType>>(
    model: string,
    filter?: Mongoose.FilterQuery<TRawDocType>,
  ...
  public async updateMany<TRawDocType, ResultDoc = Mongoose.THydratedDocumentType<TRawDocType>>(
    model: string,
    filter?: Mongoose.FilterQuery<TRawDocType>,
    update?: Mongoose.UpdateQuery<TRawDocType | Mongoose.UpdateWithAggregationPipeline>,
    options?: Mongoose.QueryOptions<TRawDocType>
  ...
  public async replaceOne<TRawDocType, ResultDoc = Mongoose.THydratedDocumentType<TRawDocType>>(
    model: string,
    filter?: Mongoose.FilterQuery<TRawDocType>,
    replacement?: TRawDocType | Mongoose.AnyObject,
    options?: Mongoose.QueryOptions<TRawDocType>
  ...
  private _catchError(e: any): ICoreError {
    return container.get<IExceptionProvider>(CoreSymbols.ExceptionProvider).throwError(e, {
      namespace: MongodbProvider.name,
      errorType: 'FATAL',
      requestId: this._contextService.store.requestId,
    });
